...
public class DoubleAutoDoor : MonoBehaviour {
	...
	public static DoubleAutoDoor instance;
	private void Awake(){
		instance = this;
	}
	...
	public int autoDoorID = 0;
	public int autoDoorIDChirl = 1;
	...
	void Update() {
		if (inTrigger == true) {
			...
			if (Input.GetKeyDown(KeyCode.Mouse0)) {
				SatanismCircle.instance.GiveHintOut(this);
				if(autoDoorID == autoDoorIDChirl){
					doorOpenClose();
				}
